...
# 数据库相关配置
# 数据库连接字符串
# SQL_DSN=iootx:ptlXFlhda3uW20@tcp(rm-wz90dmf728yfjd4cm.mysql.cn-shenzhen.rds.aliyuncs.com:3306)/iootx_ai?parseTime=true
SQL_DSN=iootx:ptlXFlhda3uW20@tcp(rm-wz90dmf728yfjd4cm.mysql.cn-shenzhen.rds.aliyuncs.com:3306)/iootx_ai?parseTime=true
# 日志数据库连接字符串
...
# 会话密钥
SESSION_SECRET=tamRsMPkGiaILT72q0aIaZiOqrt7COe8
